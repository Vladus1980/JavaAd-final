...
public class UserServiceTests {
	...
	public void saveUserTest() {
		User user = new User("Vladyslav", "Sheremeta", "valdus1980@gmail.com", "123456", true, new HashSet<AccessLevel>(Collections.singleton(AccessLevel.USER)));
		Map<String, String> form = new HashMap<String, String>() {{
			put("firstName", "Vladyslav");
			put("lastName", "Sheremeta");
			put("ADMIN", "ADMIN");
		}};		
		
		userService.saveUser(user, form);
		
		Assert.assertTrue(user.getFirstName().equals("Vladyslav"));
		Assert.assertTrue(user.getLastName().equals("Sheremeta"));
		Assert.assertFalse(user.isActive());
